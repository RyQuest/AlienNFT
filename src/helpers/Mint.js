...
export const Mint=async(tokenUrl,minPrice)=>{
   ...
   console.log("wallet_address", wallet_address);
    ...
    if (window.ethereum){ 
      ...
      const voucher =  await lazyminter.createVoucher(token,tokenUrl,minPrice);
